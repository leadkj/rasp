...
def readPicSaveFace(sourcePath,targetPath,invalidPath,*suffix):
    try:
        ...
        face_cascade = cv2.CascadeClassifier('D:\\tmp\\cv2\\data\\haarcascade_frontalface_alt2.xml')
...
if __name__ == '__main__':
    invalidPath = r'D:\tmp\cv2\invalidPath'
    sourcePath = r'D:\tmp\cv2'
    targetPath = r'D:\tmp\cv2\targetPath'
